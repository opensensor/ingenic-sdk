...
static int isp_info_show(struct seq_file *m, void *v)
{
	...
	seq_printf(m ,"ISP gain log2 id : %d\n", gain_log2_id);
	seq_printf(m ,"ISP total gain : %d\n", total_gain);
	seq_printf(m ,"ISP exposure log2 id: %d\n", exposure_log2_id);
	seq_printf(m ,"ISP EV Value: %d\n", manual_exposure_time);
	seq_printf(m ,"ISP AE strategy: %s\n", ae_strategy);
	seq_printf(m ,"ISP Antiflicker : %d[0 means disable]\n", flicker);
	seq_printf(m ,"Evtolux Probability Enable  : %d\n", evtolux);
	seq_printf(m ,"ISP WB Gain00 : %d\n", apical_isp_white_balance_gain_00_read());
	seq_printf(m ,"ISP WB Gain01 : %d\n", apical_isp_white_balance_gain_01_read());
	seq_printf(m ,"ISP WB Gain10 : %d\n", apical_isp_white_balance_gain_10_read());
	seq_printf(m ,"ISP WB Gain11 : %d\n", apical_isp_white_balance_gain_11_read());
	seq_printf(m ,"ISP WB rg : %d\n", apical_isp_metering_awb_rg_read());
	seq_printf(m ,"ISP WB bg : %d\n", apical_isp_metering_awb_bg_read());
	seq_printf(m ,"ISP WB Temperature : %d\n", temperature);
	seq_printf(m ,"ISP Black level 00 : %d\n", apical_isp_offset_black_00_read());
	seq_printf(m ,"ISP Black level 01 : %d\n", apical_isp_offset_black_01_read());
	seq_printf(m ,"ISP Black level 10 : %d\n", apical_isp_offset_black_10_read());
	seq_printf(m ,"ISP Black level 11 : %d\n", apical_isp_offset_black_11_read());
	seq_printf(m ,"ISP LSC mesh module : %s\n", apical_isp_mesh_shading_enable_read()?"enable":"disable");
	seq_printf(m ,"ISP LSC mesh blend mode : %d\n", apical_isp_mesh_shading_mesh_alpha_mode_read());
	seq_printf(m ,"ISP LSC mesh R table : %d\n", apical_isp_mesh_shading_mesh_alpha_bank_r_read());
	seq_printf(m ,"ISP LSC mesh G table : %d\n", apical_isp_mesh_shading_mesh_alpha_bank_g_read());
	seq_printf(m ,"ISP LSC mesh B table : %d\n", apical_isp_mesh_shading_mesh_alpha_bank_b_read());
	seq_printf(m ,"ISP LSC mesh R blend : %d\n", apical_isp_mesh_shading_mesh_alpha_r_read());
	seq_printf(m ,"ISP LSC mesh G blend : %d\n", apical_isp_mesh_shading_mesh_alpha_g_read());
	seq_printf(m ,"ISP LSC mesh B blend : %d\n", apical_isp_mesh_shading_mesh_alpha_b_read());
	seq_printf(m ,"ISP LSC mesh shading strength : %d\n", APICAL_READ_32(0x39c));
	seq_printf(m ,"ISP Sinter thresh1h : %d\n", apical_isp_sinter_thresh_1h_read());
	seq_printf(m ,"ISP Sinter thresh4h : %d\n", apical_isp_sinter_thresh_4h_read());
	seq_printf(m ,"ISP Sinter thresh1v : %d\n", apical_isp_sinter_thresh_1v_read());
	seq_printf(m ,"ISP Sinter thresh4v : %d\n", apical_isp_sinter_thresh_4v_read());
	seq_printf(m ,"ISP Sinter thresh short : %d\n", apical_isp_sinter_thresh_short_read());
	seq_printf(m ,"ISP Sinter thresh long : %d\n", apical_isp_sinter_thresh_long_read());
	seq_printf(m ,"ISP Sinter strength1 : %d\n", apical_isp_sinter_strength_1_read());
	seq_printf(m ,"ISP Sinter strength4 : %d\n", apical_isp_sinter_strength_4_read());
	seq_printf(m ,"ISP Temper thresh module :%s\n", apical_isp_temper_enable_read()?"enable":"disable");
	seq_printf(m ,"ISP Temper thresh short : %d\n", apical_isp_temper_thresh_short_read());
	seq_printf(m ,"ISP Temper thresh long : %d\n", apical_isp_temper_thresh_long_read());
	seq_printf(m ,"ISP Iridix strength : %d\n", apical_isp_iridix_strength_read());
	seq_printf(m ,"ISP Defect pixel threshold : %d\n", apical_isp_raw_frontend_dp_threshold_read());
	seq_printf(m ,"ISP Defect pixel slope : %d\n", apical_isp_raw_frontend_dp_slope_read());
	seq_printf(m ,"ISP sharpening directional : %d\n", apical_isp_demosaic_sharp_alt_d_read());
	seq_printf(m ,"ISP sharpening undirectional : %d\n", apical_isp_demosaic_sharp_alt_ud_read());
	seq_printf(m ,"ISP FR sharpen strength : %d\n", apical_isp_fr_sharpen_strength_read());
	seq_printf(m ,"ISP DS1 sharpen strength : %d\n", apical_isp_ds1_sharpen_strength_read());
#if TX_ISP_EXIST_DS2_CHANNEL
	seq_printf(m ,"ISP DS2 sharpen strength : %d\n", apical_isp_ds2_sharpen_strength_read());
#endif
	seq_printf(m ,"ISP CCM R_R : %d\n", apical_isp_matrix_rgb_coefft_r_r_read());
	seq_printf(m ,"ISP CCM R_G : %d\n", apical_isp_matrix_rgb_coefft_r_g_read());
	seq_printf(m ,"ISP CCM R_B : %d\n", apical_isp_matrix_rgb_coefft_r_b_read());
	seq_printf(m ,"ISP CCM G_R : %d\n", apical_isp_matrix_rgb_coefft_g_r_read());
	seq_printf(m ,"ISP CCM G_B : %d\n", apical_isp_matrix_rgb_coefft_g_b_read());
	seq_printf(m ,"ISP CCM G_G : %d\n", apical_isp_matrix_rgb_coefft_g_g_read());
	seq_printf(m ,"ISP CCM B_R : %d\n", apical_isp_matrix_rgb_coefft_b_r_read());
	seq_printf(m ,"ISP CCM B_G : %d\n", apical_isp_matrix_rgb_coefft_b_g_read());
	seq_printf(m ,"ISP CCM B_B : %d\n", apical_isp_matrix_rgb_coefft_b_b_read());
	seq_printf(m ,"Saturation Target : %d\n", saturation_target);
