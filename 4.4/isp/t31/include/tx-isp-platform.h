...
#ifndef __TX_ISP_PLATFORM_H__
#define __TX_ISP_PLATFORM_H__
...
static u64 private_tx_isp_module_dma_mask = ~(u64)0;
...
static void private_tx_isp_release_device(struct device *dev)
{
...
struct private_tx_isp_widget_descriptor private_tx_isp_widget_vin = {
...
struct platform_device private_tx_isp_vin_platform_device = {
		.name = TX_ISP_VIN_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_widget_vin,
				.release = private_tx_isp_release_device,
		},
		.num_resources = 0,
};
...
static struct resource private_tx_isp_csi_resource[] = {
		[0] = {
				/*.name = "mipi_csi",*/
...
static struct private_tx_isp_device_clk isp_csi_clk_info[] = {
		{"csi", DUMMY_CLOCK_RATE},
};

struct private_tx_isp_widget_descriptor private_tx_isp_widget_csi = {
		.type = TX_ISP_TYPE_WIDGET,
...
struct platform_device private_tx_isp_csi_platform_device = {
		.name = TX_ISP_CSI_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_widget_csi,
				.release = private_tx_isp_release_device,
		},
		.num_resources = ARRAY_SIZE(private_tx_isp_csi_resource),
		.resource = private_tx_isp_csi_resource,
};

/* It's a process unit that connects several interfaces of sensor */
static struct resource private_tx_isp_vic_resource[] = {
		[0] = {
				.name = TX_ISP_DEV_NAME,
...
struct private_tx_isp_widget_descriptor private_tx_isp_widget_vic = {
		.type = TX_ISP_TYPE_WIDGET,
...
struct platform_device private_tx_isp_vic_platform_device = {
		.name = TX_ISP_VIC_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_widget_vic,
				.release = private_tx_isp_release_device,
		},
		.num_resources = ARRAY_SIZE(private_tx_isp_vic_resource),
		.resource = private_tx_isp_vic_resource,
};

/* It's the first process unit */
static struct resource private_tx_isp_core_resource[] = {
		[0] = {
				.name = TX_ISP_DEV_NAME,
				/*.name = "isp_device",*/
...
static struct private_tx_isp_device_clk isp_core_clk_info[] = {
		{"cgu_isp", 85000000},
		{"isp", DUMMY_CLOCK_RATE},
};

struct private_tx_isp_pad_descriptor private_tx_isp_core_pads[] = {
		{
...
struct private_tx_isp_subdev_descriptor private_tx_isp_subdev_ispcore = {
		...
		.pads_num = ARRAY_SIZE(private_tx_isp_core_pads),
		.pads = private_tx_isp_core_pads,
};

struct platform_device private_tx_isp_core_platform_device = {
		.name = TX_ISP_CORE_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_subdev_ispcore,
				.release = private_tx_isp_release_device,
		},
		.num_resources = ARRAY_SIZE(private_tx_isp_core_resource),
		.resource = private_tx_isp_core_resource,
};

/* It's the second process unit */
static struct resource private_tx_isp_ldc_resource[] = {
		[0] = {
				.name = TX_ISP_DEV_NAME,
				/*.name = "isp_device",*/
...
static struct private_tx_isp_device_clk isp_ldc_clk_info[] = {
		{"ldc", DUMMY_CLOCK_RATE},
		{"ahb1", DUMMY_CLOCK_RATE},
};

struct private_tx_isp_pad_descriptor private_tx_isp_ldc_pads[] = {
		{
				.type = TX_ISP_PADTYPE_OUTPUT,
...
struct private_tx_isp_subdev_descriptor private_tx_isp_subdev_ldc = {
		.type = TX_ISP_TYPE_SUBDEV,
		.subtype = TX_ISP_SUBTYPE_PROCESSING_UNIT,
		.parentid = TX_ISP_HEADER_ID(0),
		...
		.pads_num = ARRAY_SIZE(private_tx_isp_ldc_pads),
		.pads = private_tx_isp_ldc_pads,
};

struct platform_device private_tx_isp_ldc_platform_device = {
		.name = TX_ISP_LDC_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_subdev_ldc,
				.release = private_tx_isp_release_device,
		},
		.num_resources = ARRAY_SIZE(private_tx_isp_ldc_resource),
		.resource = private_tx_isp_ldc_resource,
};

/* It's the thrid process unit */
static struct resource private_tx_isp_ncu_resource[] = {
		[0] = {
				.name = TX_ISP_DEV_NAME,
...
static struct private_tx_isp_device_clk isp_ncu_clk_info[] = {
		{"ncu", DUMMY_CLOCK_RATE},
};

struct private_tx_isp_pad_descriptor private_tx_isp_ncu_pads[] = {
		{
				.type = TX_ISP_PADTYPE_INPUT,
				.links_type = TX_ISP_PADLINK_DDR | TX_ISP_PADLINK_LFB,
		},
...
struct private_tx_isp_subdev_descriptor private_tx_isp_subdev_ncu = {
		.type = TX_ISP_TYPE_SUBDEV,
		.subtype = TX_ISP_SUBTYPE_PROCESSING_UNIT,
		.parentid = TX_ISP_HEADER_ID(0),
		...
		.pads_num = ARRAY_SIZE(private_tx_isp_ncu_pads),
		.pads = private_tx_isp_ncu_pads,
};

struct platform_device private_tx_isp_ncu_platform_device = {
		.name = TX_ISP_NCU_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_subdev_ncu,
				.release = private_tx_isp_release_device,
		},
		.num_resources = ARRAY_SIZE(private_tx_isp_ncu_resource),
		.resource = private_tx_isp_ncu_resource,
};

/* It's the fourth process unit */
static struct resource private_tx_isp_ms_resource[] = {
		[0] = {
				.name = TX_ISP_DEV_NAME,
...
static struct private_tx_isp_device_clk isp_ms_clk_info[] = {
		{"mscaler", DUMMY_CLOCK_RATE},
};

struct private_tx_isp_pad_descriptor private_tx_isp_ms_pads[] = {
		{
				.type = TX_ISP_PADTYPE_INPUT,
				.links_type = TX_ISP_PADLINK_LFB,
		},
...
struct private_tx_isp_subdev_descriptor private_tx_isp_subdev_ms = {
		.type = TX_ISP_TYPE_SUBDEV,
		.subtype = TX_ISP_SUBTYPE_PROCESSING_UNIT,
		.parentid = TX_ISP_HEADER_ID(0),
		...
		.pads_num = ARRAY_SIZE(private_tx_isp_ms_pads),
		.pads = private_tx_isp_ms_pads,
};

struct platform_device private_tx_isp_ms_platform_device = {
		.name = TX_ISP_MSCALER_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_subdev_ms,
				.release = private_tx_isp_release_device,
		},
		.num_resources = ARRAY_SIZE(private_tx_isp_ms_resource),
		.resource = private_tx_isp_ms_resource,
};

struct private_tx_isp_pad_descriptor private_tx_isp_fs_pads[] = {
		{
				.type = TX_ISP_PADTYPE_OUTPUT,
				.links_type = TX_ISP_PADLINK_DDR,
		},
...
struct private_tx_isp_subdev_descriptor private_tx_isp_subdev_framesource = {
		.type = TX_ISP_TYPE_SUBDEV,
		.subtype = TX_ISP_SUBTYPE_OUTPUT_TERMINAL,
		.parentid = TX_ISP_HEADER_ID(0),
		.unitid = TX_ISP_SUBDEV_ID(4),
		.clks_num = 0,
		.pads_num = ARRAY_SIZE(private_tx_isp_fs_pads),
		.pads = private_tx_isp_fs_pads,
};

struct platform_device private_tx_isp_fs_platform_device = {
		.name = TX_ISP_FS_NAME,
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_isp_subdev_framesource,
				.release = private_tx_isp_release_device,
		},
		.num_resources = 0,
};

struct platform_device *private_tx_isp_devices[] = {
		/* isp core and its widgets */
		&private_tx_isp_core_platform_device,
		&private_tx_isp_vic_platform_device,
		&private_tx_isp_csi_platform_device,
		&private_tx_isp_vin_platform_device,
		/* ldc module and its widgets */
		&private_tx_isp_ldc_platform_device,
		/* ncu module and its widgets */
		&private_tx_isp_ncu_platform_device,
		/* mscaler module and its widgets */
		&private_tx_isp_ms_platform_device,
		/* framesource module and its widgets */
		&private_tx_isp_fs_platform_device,
};


/* It's the root device */
struct private_tx_isp_device_descriptor private_tx_video_device = {
		.type = TX_ISP_TYPE_HEADER,
		.subtype = TX_ISP_SUBTYPE_CONTROLLER,
		.parentid = -1,
		.unitid = TX_ISP_HEADER_ID(0),
		.entity_num = ARRAY_SIZE(private_tx_isp_devices),
		.entities = private_tx_isp_devices,
};

struct platform_device private_tx_isp_platform_device = {
		.name = "tx-isp",
		.id = -1,
		.dev = {
				.dma_mask = &private_tx_isp_module_dma_mask,
				.coherent_dma_mask = 0xffffffff,
				.platform_data = &private_tx_video_device,
				.release = private_tx_isp_release_device,
		},
		.num_resources = 0,
};
